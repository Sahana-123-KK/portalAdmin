...
import Navbar from "../../components/navbar/navbar"
import dashboardImg from "E:/he/my-app/src/images/dashboard.png"
import dashboardImgg from "E:/he/my-app/src/images/dashboard-1.png"
...
export default function Dashboard(props) {
  return (
    <div>
      ...
      <div className="container-fluid dash-control">
        ...
        <div className="container dash-content">
            ...
            <div class="d-flex justify-content-between title-dash flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      {/* <img src="" alt="" /> */}
      <div className="images-dash">
        
      <img className='img-sizing' src= {dashboardImgg} alt=""  />
      <img className='img-sizing' src= {dashboardImg} alt=""  />
      
      </div>

        </div>
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse navv-left">
